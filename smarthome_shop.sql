...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 24. Mrz 2022 um 12:31
...
ALTER TABLE `order_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_products_order` (`order_id`),
  ADD KEY `order_products_products` (`product_id`);
...
--
ALTER TABLE `order_products`
  ADD CONSTRAINT `order_products_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `order_products_products` FOREIGN KEY (`product_id`) REFERENCES `orders` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
